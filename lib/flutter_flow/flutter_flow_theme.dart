...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryText = const Color(0xFF1A1F25);
  ...
  late Color warningOld = const Color(0xFF1A1F25);
  late Color failed = const Color(0xFFDB3333);
  late Color backgroundComponents = const Color(0xFFF2F2F2);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xFF1A1F25);
  ...
  late Color failed = const Color(0xFFDB3333);
  late Color backgroundComponents = const Color(0xFF1A1F25);
}
