...
class TrendyTable extends SupabaseTable<TrendyRow> {
  @override
  String get tableName => 'trendy';

  @override
  TrendyRow createRow(Map<String, dynamic> data) => TrendyRow(data);
}

class TrendyRow extends SupabaseDataRow {
  TrendyRow(super.data);

  @override
  SupabaseTable get table => TrendyTable();
